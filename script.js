...
let buttonWidth = 80;
let fontSize = 20;
const imagePaths = ['./images/image1.gif','./images/image2.gif','./images/image3.gif','./images/image4.gif','./images/image5.gif','./images/image6.gif','./images/default.gif'];
...
const getRandomNumber = (num) => {return Math.floor(Math.random() * (num + 1));};
  ...
  noButton.addEventListener("click", () => {
    ...
    if (noClickCount < 4) {
      ...
      //no button text
      const messages = ["No","Are you sure?","pleaseeee??","Don't do this to me :(","Say yes or else...",];
